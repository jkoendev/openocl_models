...
puma560 = Puma560();
ode = @(h,x,z,u,p) p560_ocl_ode_codegen(h,x,u,puma560);

solver = ocl.Solver(T, @p560_ocl_vars_codegen, ode, ...
                    'pathcosts', @p560_ocl_cost_torques, ...
                    'gridconstraints', @(h,k,K,x,p)p560_ocl_codegen_constraints(h,k,x,wp1,wp2), ...
                    'N', N);
